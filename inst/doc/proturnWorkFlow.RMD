...
proteome-wise study of protein turnover rate ^[Boisvert, François-Michel, Yasmeen Ahmad, Marek Gierliński, Fabien Charrière, Douglas Lamont, Michelle Scott, Geoff Barton, and Angus I. Lamond. 2012. “A Quantitative Spatial Proteomics Analysis of Proteome Turnover in Human Cells.” Molecular & Cellular Proteomics: MCP 11 (3): M111.011429.]. 
...
As a result, the proportion of undegradated proteins is available at different time points, which
...
An instruction about how to use the shiny app could be find [here][shinyintro]^[update link].
